...
public:
    ...
    void dijkstra(T s)
    {
        ...
        set<pair<int, T>> minHeap; // to keep track of unexplored vertices // when you creae a set of pair then set property is based on the 1st elment of the pair
        ...
        // space: O(V) due to (minHeap+exploredSet) and distMap
